...
class NewsDetailsViewModelTest {
    ...
    private val mockMediaMetadata = listOf(
        MediaMetadata(
    ...
    private val mockNewsItem = Result(
    ...
    @Test
    fun `initialization should set item in state`() = runTest {
        // When
        ...
        viewModel.state.test {
            ...
            assertThat(currentState.item?.abstract).isEqualTo("This is a test abstract for a news article that provides a brief summary of the content.")
    ...
    @Test
    fun `state should contain correct media information`() = runTest {
        // When
        val viewModel = NewsDetailsViewModel(mockNewsItem)
    ...
    @Test
    fun `state should contain correct facet information`() = runTest {
        // When
        val viewModel = NewsDetailsViewModel(mockNewsItem)
    ...
    @Test
    fun `state should handle item with minimal media`() = runTest {
        // Given
    ...
    @Test
    fun `state should handle item with null column`() = runTest {
        // Given
    ...
    @Test
    fun `state should contain all required article metadata`() = runTest {
        // When
        val viewModel = NewsDetailsViewModel(mockNewsItem)
        ...
        viewModel.state.test {
            ...
            assertThat(item?.url).isEqualTo("https://www.nytimes.com/2025/01/15/technology/ai-transforms-daily-life.html")
    ...
    @Test
    fun `state should be immutable after initialization`() = runTest {
        // Given
        val viewModel = NewsDetailsViewModel(mockNewsItem)
